...
from polars_uuid._register_plugin import u128_to_uuid as u128_to_uuid
...
from polars_uuid._register_plugin import (
    uuid_v8_by_hashing_str as uuid_v8_by_hashing_str,
)
